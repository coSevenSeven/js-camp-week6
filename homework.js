...
2. GET、POST、PATCH、PUT、DELETE 的差異
	 ...
	 GET    ➡️ 取得資料
	 POST   ➡️ 新增資料
	 PATCH  ➡️ 修改部分資料，送出的資料不一定是完整的內容
	 PUT    ➡️ 修改全部資料，送出的完整的資料
	 DELETE ➡️ 刪除資料

3. 什麼是 RESTful API？
	 答： 一種設計原則 
				1. 每個資源都有為一個網址 (Resource-Based)
				2. 使用 HTTP method GET、POST、PATCH、PUT、DELETE (HTTP Verbs)
				3. 請求之間互不關聯 (Stateless)
*/
